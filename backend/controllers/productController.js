    ...
    try {
        ...
        if (req.file) {
            image = {
                ...
                path: "https://ecommerce-food-mart.onrender.com/uploads/" + req.file.path,
            };
        }
...
const updateProduct = async (req, res) => {
    try {
        ...
        if (req.file) {
            updated.image = {
                filename: req.file.filename,
                path: "https://ecommerce-food-mart.onrender.com/uploads/" + req.file.path, // ✅ store relative path!
            };
        }
